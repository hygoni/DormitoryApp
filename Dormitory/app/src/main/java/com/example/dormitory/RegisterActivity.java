    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
                                dialog = builder.setMessage("회원가입에 실패했습니다.").setNegativeButton("확인", null).create();
                                dialog.show();
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                ...
                RegisterRequest registerRequest = new RegisterRequest(userID,userPassword, userGender,userNickname,userDong, responseListener);
